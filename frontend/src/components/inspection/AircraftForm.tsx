      ...
      <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Registration / Tail Number</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Aircraft Make</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Aircraft Model</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Airframe Serial Number</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Year of Manufacture</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Inspection Type</label>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Engine Make</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Engine Model</label>
            ...
            <div className="col-span-2">
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Engine Serial Number(s)</label>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Total Airframe Time (hrs)</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Total Engine Hours (hrs)</label>
        ...
        <section className="space-y-4 opacity-80">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Propeller Make & Model</label>
            ...
            <div>
              <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-[0.04em] text-text-tertiary">Propeller Serial Number(s)</label>
